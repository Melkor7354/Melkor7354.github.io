...
NotebookDataLength[      2995,         80]
NotebookOptionsPosition[      3495,         75]
NotebookOutlinePosition[      3976,         95]
CellTagsIndexPosition[      3933,         92]
WindowFrame->Normal*)
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`color$$ = RGBColor[
    ...
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{
      ...
      RGBColor[0, 0, 1]}}, Typeset`size$$ = {255., {74., 78.41832724372424}}, 
...
{$CellContext`x, 0, 2 Pi}, PlotStyle -> $CellContext`color$$], 
     ...
     ImageSizeCache->{539., {102.3, 107.7}},
   ...
   Deployed->True,
   StripOnInput->False],
  Manipulate`InterpretManipulate[1]]], "",ExpressionUUID->"cb837c81-6bc2-4f50-\
8611-dd59b7af8cc3"]
},
Visible->True,
...
ExpressionUUID->"c243a37e-0208-46c0-8079-17d0f0269391"
]
...
(*NotebookFileOutline
Notebook[{
Cell[1488, 33, 2003, 40, 220, "",ExpressionUUID->"cb837c81-6bc2-4f50-8611-dd59b7af8cc3"]
}
]
*)
...
(* NotebookSignature pv0RyuKa54ZmQC1IYOjhYd8E *)
